...
// The Loop
while ( have_posts() ) : the_post();?>	<div class="post-main studrada-novini category" style="width:100%">
...
<?php endif; ?>
       ...
       <div class="pag category"> <?php if(function_exists('wp_pagenavi')) { wp_pagenavi(); } ?>
	   <?php //wp_pagenavi(); ?>
</div>
